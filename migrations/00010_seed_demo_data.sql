...
VALUES
    ...
    ('ab000001-0000-0000-0000-000000000001', 'aa000001-0000-0000-0000-000000000002'),
    ('ab000001-0000-0000-0000-000000000001', 'aa000001-0000-0000-0000-000000000003')
...
VALUES
    ('ac000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'upload', 'completed', 3, NULL, NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day' + INTERVAL '5 seconds'),
    ('ac000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000002', 'upload', 'failed', 0, 'Connection timeout after 30s', NOW() - INTERVAL '6 hours', NULL)
ON CONFLICT (id) DO NOTHING;
...
-- +goose Down
-- +goose StatementBegin
DELETE FROM sync_sessions WHERE id IN ('ac000001-0000-0000-0000-000000000001', 'ac000001-0000-0000-0000-000000000002');
DELETE FROM shift_transactions WHERE shift_id = 'ab000001-0000-0000-0000-000000000001';
DELETE FROM shifts WHERE id = 'ab000001-0000-0000-0000-000000000001';
DELETE FROM transactions WHERE id::text LIKE 'aa000001%';
