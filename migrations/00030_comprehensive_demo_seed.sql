...
('ex000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000001', 350000, 'Beli deterjen 10kg', (NOW() - INTERVAL '25 days')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000001', 150000, 'Beli pewangi 5L', (NOW() - INTERVAL '20 days')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000002', 850000, 'Tagihan listrik bulan ini', (NOW() - INTERVAL '15 days')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000004', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000002', 250000, 'Tagihan air', (NOW() - INTERVAL '15 days')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000005', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000003', 3500000, 'Gaji kasir bulan ini', (NOW() - INTERVAL '5 days')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000006', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000002', 'ec000001-0000-0000-0000-000000000003', 3000000, 'Gaji kasir outlet 2', (NOW() - INTERVAL '5 days')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000007', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000004', 5000000, 'Sewa tempat bulan ini', (NOW() - INTERVAL '1 day')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000008', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000002', 'ec000001-0000-0000-0000-000000000004', 3500000, 'Sewa tempat outlet 2', (NOW() - INTERVAL '1 day')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000009', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000005', 100000, 'Bensin antar-jemput cucian', (NOW() - INTERVAL '3 days')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000010', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000006', 500000, 'Service mesin cuci', (NOW() - INTERVAL '10 days')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000011', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000007', 75000, 'Beli plastik packaging', (NOW() - INTERVAL '8 days')::date, 'a1000001-0000-0000-0000-000000000001'),
('ex000001-0000-0000-0000-000000000012', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'ec000001-0000-0000-0000-000000000001', 200000, 'Beli deterjen 5kg (restock)', (NOW() - INTERVAL '2 days')::date, 'a1000001-0000-0000-0000-000000000001')
ON CONFLICT (id) DO NOTHING;
...
('re000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'ec000001-0000-0000-0000-000000000004', 'b1000001-0000-0000-0000-000000000001', 5000000, 'Sewa Cabang Pusat', 'monthly', (NOW() + INTERVAL '15 days')::date, true),
('re000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'ec000001-0000-0000-0000-000000000004', 'b1000001-0000-0000-0000-000000000002', 3500000, 'Sewa Cabang Selatan', 'monthly', (NOW() + INTERVAL '15 days')::date, true),
('re000001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'ec000001-0000-0000-0000-000000000003', NULL, 6500000, 'Gaji karyawan (semua outlet)', 'monthly', (NOW() + INTERVAL '20 days')::date, true)
ON CONFLICT (id) DO NOTHING;
...
('dg000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'daily_revenue', 200000, true),
('dg000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'monthly_revenue', 5000000, true),
('dg000001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'daily_transactions', 10, true)
...
('sc000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'Deterjen', 'Drop', true),
('sc000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'Pewangi', 'Flower', true),
('sc000001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'Packaging', 'Package', true),
('sc000001-0000-0000-0000-000000000004', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'Chemicals', 'Flask', true)
...
('sp000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sc000001-0000-0000-0000-000000000001', 'b1000001-0000-0000-0000-000000000001', 'Deterjen Bubuk Attack', 'kg', 15.00, 5.00, 35000, true),
('sp000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sc000001-0000-0000-0000-000000000001', 'b1000001-0000-0000-0000-000000000001', 'Deterjen Cair Rinso', 'liter', 8.50, 3.00, 28000, true),
('sp000001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sc000001-0000-0000-0000-000000000002', 'b1000001-0000-0000-0000-000000000001', 'Pewangi Downy', 'liter', 5.00, 2.00, 30000, true),
('sp000001-0000-0000-0000-000000000004', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sc000001-0000-0000-0000-000000000003', 'b1000001-0000-0000-0000-000000000001', 'Plastik Bening 40x60', 'lembar', 200.00, 50.00, 500, true),
('sp000001-0000-0000-0000-000000000005', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sc000001-0000-0000-0000-000000000003', 'b1000001-0000-0000-0000-000000000001', 'Hanger Kawat', 'pcs', 80.00, 20.00, 1500, true),
('sp000001-0000-0000-0000-000000000006', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sc000001-0000-0000-0000-000000000004', 'b1000001-0000-0000-0000-000000000001', 'Cairan Dry Clean', 'liter', 3.00, 1.00, 85000, true),
('sp000001-0000-0000-0000-000000000007', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sc000001-0000-0000-0000-000000000001', 'b1000001-0000-0000-0000-000000000002', 'Deterjen Bubuk Attack', 'kg', 10.00, 5.00, 35000, true),
('sp000001-0000-0000-0000-000000000008', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sc000001-0000-0000-0000-000000000002', 'b1000001-0000-0000-0000-000000000002', 'Pewangi Downy', 'liter', 3.50, 2.00, 30000, true)
ON CONFLICT (id) DO NOTHING;

-- Stock movements
INSERT INTO stock_movements (id, tenant_id, supply_id, movement_type, quantity, notes, created_by, created_at) VALUES
('sm000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000001', 'in', 20.00, 'Restock deterjen', 'a1000001-0000-0000-0000-000000000001', NOW() - INTERVAL '25 days'),
('sm000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000001', 'out', 5.00, 'Pemakaian harian', 'a1000001-0000-0000-0000-000000000002', NOW() - INTERVAL '20 days'),
('sm000001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000002', 'in', 10.00, 'Beli deterjen cair', 'a1000001-0000-0000-0000-000000000001', NOW() - INTERVAL '22 days'),
('sm000001-0000-0000-0000-000000000004', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000002', 'out', 1.50, 'Pemakaian 3 hari', 'a1000001-0000-0000-0000-000000000002', NOW() - INTERVAL '15 days'),
('sm000001-0000-0000-0000-000000000005', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000003', 'in', 8.00, 'Restock pewangi', 'a1000001-0000-0000-0000-000000000001', NOW() - INTERVAL '18 days'),
('sm000001-0000-0000-0000-000000000006', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000003', 'out', 3.00, 'Pemakaian seminggu', 'a1000001-0000-0000-0000-000000000002', NOW() - INTERVAL '10 days'),
('sm000001-0000-0000-0000-000000000007', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000004', 'in', 300.00, 'Beli plastik baru', 'a1000001-0000-0000-0000-000000000001', NOW() - INTERVAL '20 days'),
('sm000001-0000-0000-0000-000000000008', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000004', 'out', 100.00, 'Pemakaian 2 minggu', 'a1000001-0000-0000-0000-000000000002', NOW() - INTERVAL '5 days'),
('sm000001-0000-0000-0000-000000000009', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000006', 'in', 5.00, 'Restock dry clean chemical', 'a1000001-0000-0000-0000-000000000001', NOW() - INTERVAL '15 days'),
('sm000001-0000-0000-0000-000000000010', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000006', 'out', 2.00, 'Pemakaian dry cleaning', 'a1000001-0000-0000-0000-000000000002', NOW() - INTERVAL '5 days'),
('sm000001-0000-0000-0000-000000000011', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000005', 'in', 100.00, 'Beli hanger baru', 'a1000001-0000-0000-0000-000000000001', NOW() - INTERVAL '12 days'),
('sm000001-0000-0000-0000-000000000012', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'sp000001-0000-0000-0000-000000000005', 'out', 20.00, 'Pemakaian seminggu', 'a1000001-0000-0000-0000-000000000002', NOW() - INTERVAL '3 days')
ON CONFLICT (id) DO NOTHING;
...
('ssm00001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'e0000001-0000-0000-0000-000000000001', 'sp000001-0000-0000-0000-000000000001', 0.10, NOW() - INTERVAL '30 days'),
('ssm00001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'e0000001-0000-0000-0000-000000000001', 'sp000001-0000-0000-0000-000000000003', 0.05, NOW() - INTERVAL '30 days'),
('ssm00001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'e0000001-0000-0000-0000-000000000006', 'sp000001-0000-0000-0000-000000000002', 0.08, NOW() - INTERVAL '30 days'),
('ssm00001-0000-0000-0000-000000000004', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'e0000001-0000-0000-0000-000000000008', 'sp000001-0000-0000-0000-000000000006', 0.50, NOW() - INTERVAL '30 days')
ON CONFLICT (id) DO NOTHING;
...
('dz000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'Zona 1 - Pusat Kota', 'Menteng, Cikini, Gondangdia', 10000, 30, true),
('dz000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'Zona 2 - Kota Selatan', 'Kemang, Blok M, Senopati', 15000, 45, true),
('dz000001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'Zona 3 - Pinggiran', 'BSD, Bintaro, Ciputat', 25000, 60, true),
('dz000001-0000-0000-0000-000000000004', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000002', 'Zona 1 - Selatan', 'Pancoran, Tebet, Pasar Minggu', 10000, 30, true),
('dz000001-0000-0000-0000-000000000005', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000002', 'Zona 2 - Selatan Jauh', 'Depok, Cinere, Lenteng Agung', 20000, 50, true)
ON CONFLICT (id) DO NOTHING;
...
('pr000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'dz000001-0000-0000-0000-000000000001', 'bb000001-0000-0000-0000-000000000001', 'Budi Santoso', '081200000001', 'Jl. Menteng Raya No. 15, Jakarta Pusat', 'delivery', 'completed', NOW() - INTERVAL '2 days', NOW() - INTERVAL '1 day', 'Antar ke rumah', 10000),
('pr000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'dz000001-0000-0000-0000-000000000002', NULL, 'Rini Wulandari', '081200000005', 'Jl. Kemang Raya No. 22, Jakarta Selatan', 'pickup', 'scheduled', NOW() + INTERVAL '2 hours', NULL, 'Jemput cucian kotor', 15000),
('pr000001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000001', 'dz000001-0000-0000-0000-000000000003', NULL, 'Hendra Gunawan', '081200000006', 'Jl. BSD Raya Blok A5, Tangerang Selatan', 'pickup', 'pending', NOW() + INTERVAL '1 day', NULL, 'Minta dijemput besok pagi', 25000),
('pr000001-0000-0000-0000-000000000004', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'b1000001-0000-0000-0000-000000000002', 'dz000001-0000-0000-0000-000000000004', 'bb000001-0000-0000-0000-000000000006', 'Walk-in Customer', '081200000099', 'Jl. Tebet Barat No. 8, Jakarta Selatan', 'delivery', 'scheduled', NOW() + INTERVAL '4 hours', NULL, 'Antar cucian yang sudah ready', 10000)
ON CONFLICT (id) DO NOTHING;
...
('sa000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000002', 'discount', 'aa000001-0000-0000-0000-000000000006', 'transaction', 3500, 'Diskon member gold 10%', NOW() - INTERVAL '28 days'),
('sa000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000002', 'discount', 'aa000001-0000-0000-0000-000000000007', 'transaction', 18900, 'Diskon member platinum 15%', NOW() - INTERVAL '25 days'),
('sa000001-0000-0000-0000-000000000003', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000002', 'void', NULL, 'transaction', 15000, 'Transaksi salah input, void oleh kasir', NOW() - INTERVAL '18 days'),
('sa000001-0000-0000-0000-000000000004', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000002', 'refund', 'aa000001-0000-0000-0000-000000000014', 'transaction', 11100, 'Customer komplain, refund penuh', NOW() - INTERVAL '7 days'),
('sa000001-0000-0000-0000-000000000005', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000002', 'discount', 'aa000001-0000-0000-0000-000000000011', 'transaction', 4200, 'Diskon member gold 10%', NOW() - INTERVAL '15 days'),
('sa000001-0000-0000-0000-000000000006', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000002', 'cancel', NULL, 'order', 0, 'Customer batal laundry', NOW() - INTERVAL '12 days'),
('sa000001-0000-0000-0000-000000000007', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000002', 'discount', 'aa000001-0000-0000-0000-000000000013', 'transaction', 19500, 'Diskon member platinum 15%', NOW() - INTERVAL '10 days'),
('sa000001-0000-0000-0000-000000000008', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000002', 'discount', 'aa000001-0000-0000-0000-000000000016', 'transaction', 2450, 'Diskon member silver 5%', NOW() - INTERVAL '5 days'),
('sa000001-0000-0000-0000-000000000009', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000001', 'void', NULL, 'transaction', 25000, 'Owner void transaksi duplikat', NOW() - INTERVAL '3 days'),
('sa000001-0000-0000-0000-000000000010', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'a1000001-0000-0000-0000-000000000002', 'discount', 'aa000001-0000-0000-0000-000000000025', 'transaction', 2100, 'Diskon member silver 5%', NOW() - INTERVAL '2 hours')
ON CONFLICT (id) DO NOTHING;
...
('pt000001-0000-0000-0000-000000000001', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'f1000001-0000-0000-0000-000000000009', 100, 10000, 'aa000001-0000-0000-0000-000000000013', NOW() - INTERVAL '10 days'),
('pt000001-0000-0000-0000-000000000002', 'e701d2d3-f5d6-45d2-8202-fb514a695377', 'f1000001-0000-0000-0000-000000000001', 50, 5000, 'aa000001-0000-0000-0000-000000000019', NOW() - INTERVAL '3 days')
ON CONFLICT (id) DO NOTHING;
...
DELETE FROM point_redemptions WHERE id LIKE 'pt000001%';
DELETE FROM staff_activity_logs WHERE id LIKE 'sa000001%';
DELETE FROM pickup_requests WHERE id LIKE 'pr000001%';
DELETE FROM delivery_zones WHERE id LIKE 'dz000001%';
DELETE FROM service_supply_mappings WHERE id LIKE 'ssm00001%';
DELETE FROM stock_movements WHERE id LIKE 'sm000001%';
DELETE FROM supplies WHERE id LIKE 'sp000001%';
DELETE FROM supply_categories WHERE id LIKE 'sc000001%';
DELETE FROM recurring_expenses WHERE id LIKE 're000001%';
DELETE FROM expenses WHERE id LIKE 'ex000001%';
DELETE FROM expense_categories WHERE id LIKE 'ec000001%';
DELETE FROM dashboard_goals WHERE id LIKE 'dg000001%';
